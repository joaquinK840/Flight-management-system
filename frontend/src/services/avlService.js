...
export const getTree = async () => {
    try {
        ...
        if (!response.ok) {
            throw new Error('Error al obtener el arbol');
        }
        return await response.json();
    } catch (error) {
...
export const resetTree = async () => {
    try {
        ...
        if (!response.ok) {
            throw new Error('Error al reiniciar el arbol');
        }
        return await response.json();
    } catch (error) {
...
export const getMetrics = async () => {
    try {
        ...
        if (!response.ok) {
            throw new Error('Error al obtener las metricas');
        }
        return await response.json();
    } catch (error) {
...
export const exportTree = async () => {
    try {
        ...
        if (!response.ok) {
            throw new Error('Error al exportar el arbol');
        }
