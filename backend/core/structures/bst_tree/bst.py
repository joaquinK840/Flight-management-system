...
class BST:
    """
    Binary Search Tree (sin balanceo automatico).
    Utilizado para comparar contra AVL con los mismos datos.
    Single Responsibility: solo insertion ordenada, sin rotaciones.
    """
    ...
    def insert(self, node):
        """
        Inserta un nodo en el arbol manteniendo la propiedad BST.
    ...
    def _update_height_branch(self, node):
        """
        Actualiza alturas hacia la raiz (sin rotaciones).
        """
    ...
    def contar_nodos(self):
        """Cuenta el numero total de nodos."""
